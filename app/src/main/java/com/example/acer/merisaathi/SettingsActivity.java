...
import static com.example.acer.merisaathi.Form.i;

public class SettingsActivity extends AppCompatActivity {
    DatePickerDialog.OnDateSetListener mDateSetListener;
    Button addbtn1, addbtn2, addbtn3, addbtn4, addbtn5, addbtn6,b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String lname = formPreference.getString("lastname", "");
        String dob = formPreference.getString("DOB", "");
        String pDays = formPreference.getString("periodDays", "");
        String pCycle = formPreference.getString("periodDate", "");
        ...
        showDialogOnClick();
        tvname=(TextView)findViewById(R.id.settings_tv1);

        b1 = (Button) findViewById(R.id.settings_submitButton);
        avgPdays = (EditText) findViewById(R.id.settings_averageperiodays);
        avgPcycle = (EditText) findViewById(R.id.settings_averageperiodcycle);
        tv[0] = (TextView) findViewById(R.id.settings_contacts1);
        tv[1] = (TextView) findViewById(R.id.settings_contacts2);

        tv[2] = (TextView) findViewById(R.id.settings_contacts3);

        tv[3] = (TextView) findViewById(R.id.settings_contacts4);

        tv[4] = (TextView) findViewById(R.id.settings_contacts5);
        avgPdays.setText(pDays);
        avgPcycle.setText(pCycle);
        tvname.setText(fname+" "+ lname);


        tv[0].setText(contacts1);
        tv[1].setText(contacts2);
        tv[2].setText(contacts3);
        tv[3].setText(contacts4);
        tv[4].setText(contacts5);
...
//        editor.commit();
        tvdate = (TextView) findViewById(R.id.settings_datetv);
        tvdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog1 = new DatePickerDialog(SettingsActivity.this, android.R.style.Theme_Holo_Light_Dialog_NoActionBar, mDateSetListener, year1, month1, day1);
        ...
        mDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
                ...
                month1 = i1 + 1;
                day1 = i2;
           //     Toast.makeText(SettingsActivity.this, "" + year1 + "/" + month1 + "/" + day1, Toast.LENGTH_SHORT).show();
                String date = "" + year1 + "/" + month1 + "/" + day1;
                tvdate.setText("" + year1 + "/" + month1 + "/" + day1);

            }
        };
        Button submitButton = (Button) findViewById(R.id.settings_submitButton);
...
//                get_lastname();
                ...
                editor.putString("contacts5", contact5);
                editor.commit();
                Intent intent = new Intent(SettingsActivity.this, NavigationDrawer.class);
                intent.putExtra("message", fname + " " + lname);
        ...
        tv[0].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i = 0;
           //     Toast.makeText(SettingsActivity.this, "value of i " + i, Toast.LENGTH_SHORT).show();
...
//       });
    ...
    public void showDialogOnClick() {
        tvperiod = (TextView) findViewById(R.id.settings_datetv2);
    ...
    private DatePickerDialog.OnDateSetListener dpicker = new DatePickerDialog.OnDateSetListener() {
        ...
        //    Toast.makeText(SettingsActivity.this, "" + year + "/" + month + "/" + day, Toast.LENGTH_SHORT).show();
        }
    };
    @Override
